{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyP8R9lGZAdy2gJ4QTSqvfPm",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/mazzirayenechorouk-stack/test/blob/main/tasks_py.ipynb\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      "source": [
        "!pip install flake8 ipdb"
      ],
      "metadata": {
        "colab": {
        ...
        "id": "ZGkKwDwmIXKb",
        "outputId": "480c69c7-bf88-4d49-e1ea-c2d92b18d11d"
      },
      ...
      "outputs": [
        {
          ...
          "text": [
            ...
            "Requirement already satisfied: parso<0.9.0,>=0.8.4 in /usr/local/lib/python3.12/dist-packages (from jedi>=0.16->ipython>=7.31.1->ipdb) (0.8.6)\n",
            ...
            "Requirement already satisfied: wcwidth in /usr/local/lib/python3.12/dist-packages (from prompt-toolkit!=3.0.0,!=3.0.1,<3.1.0,>=2.0.0->ipython>=7.31.1->ipdb) (0.6.0)\n",
            ...
            "\u001b[?25hInstalling collected packages: pyflakes, pycodestyle, mccabe, jedi, flake8, ipdb\n",
            "Successfully installed flake8-7.3.0 ipdb-0.13.13 jedi-0.19.2 mccabe-0.7.0 pycodestyle-2.14.0 pyflakes-3.4.0\n"
          ]
        }
      ]
    },
    {
      ...
      "metadata": {
        ...
        "id": "DSN4Gio7CQnx",
        "outputId": "7df2c155-e793-4e28-a18e-3d9c9057ef1f"
      },
      "outputs": [
        {
          "output_type": "stream",
          ...
          "text": [
            ...
            "Enter task description: send email to supervisor\n",
            ...
            "1. do homework [Done]\n",
            "2. send email to supervisor [Not done]\n",
            "Enter task number: 2\n",
            "Task marked as done.\n",
            "\n",
            "--- Task Manager ---\n",
            ...
            "4. Exit\n",
            "Choose an option (1-4): 1\n",
            "Enter task description: read 2 articles \n",
            "Task added successfully.\n",
            "\n",
            "--- Task Manager ---\n",
            "1. Add task\n",
